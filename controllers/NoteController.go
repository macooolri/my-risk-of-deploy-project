...
var NoteCreate = func(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		// Инкрементируем счетчик созданных заметок
		prometheus.NotesCreatedTotal.Inc()
...
var NoteUpdate = func(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		// Инкрементируем счетчик обновленных заметок
		prometheus.NotesUpdatedTotal.Inc()
...
var NoteDelete = func(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		// Инкрементируем счетчик удаленных заметок
		prometheus.NotesDeletedTotal.Inc()
		u.Respond(w, u.Message(true, "OK"))
	}
}
